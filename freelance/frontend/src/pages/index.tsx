      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-primary-900 via-primary-800 to-primary-600">
        ...
        <div className="section-container relative z-10 py-24 md:py-32">
          ...
          >
            ...
            {/* Headline */}
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-black text-white leading-[1.12] tracking-tight mb-5">
              {t('home.hero_title')}
            </h1>
            <p className="text-primary-200 text-lg md:text-xl leading-relaxed mb-10 max-w-xl mx-auto">
              {t('home.hero_subtitle')}
            </p>

            {/* Search bar */}
            <form onSubmit={handleSearch} className="flex gap-2 bg-white rounded-2xl shadow-2xl p-2 max-w-xl mx-auto mb-5">
